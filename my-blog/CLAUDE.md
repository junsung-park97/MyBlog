...
- 사용자는 랜딩 페이지 및 메인 페이지에서 전체 프로젝트 목록을 확인할 수 있다.
- 각 프로젝트는 카드 형태로 노출된다.

**프로젝트 선택**

- 사용자는 메인 페이지에서 특정 프로젝트를 선택할 수 있다.
- 프로젝트 선택 시, 해당 프로젝트에 포함된 게시글(Post) 목록 페이지로 이동한다.

**게시글 목록 페이지**

- 사용자는 선택한 프로젝트에 속한 게시글 목록을 확인할 수 있다.
- 게시글 목록은 최신순 기준으로 정렬된다.

**게시글 상세 페이지**

- 사용자는 게시글 목록에서 특정 게시글을 선택할 수 있다.
- 선택한 게시글의 상세 콘텐츠(본문)를 확인할 수 있다.
